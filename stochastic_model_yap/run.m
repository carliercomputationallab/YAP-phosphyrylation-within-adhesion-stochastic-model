...
%rates = ['Rb' 'Ra' 'Ru,YAP' 'Ru,pYAP' 'Rdeph'] 
%Ra is the same as the Rp in the paper

%For the full parameter set for each figure in the manuscript see Tables S1-S3
...
%### run simulation and plot average pYAP ratio vs. time for each parameter
%set given in rates
